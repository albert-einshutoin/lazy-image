...
**選定したlocal workerd構成でPASS。** 着手時mainは`a517f14a16acbe8ff380def23c4259ceeeae5485`、実測コードは`9c22cf3cdeeb7aa515b59107a2834e2c14495323`（dirty=false、対象source files SHA-256 `a5ff76cdd2586f1cbff6b7717e0583dff570853ea4eaeabe71a9217d93fc46f5`）。正例は2026-09-25 10:56:15 UTC、4負例は同日10:56:34–41 UTCの別runである。測定対象は公開npmの`@alberteinshutoin/lazy-image-wasm@1.4.0`。 [実installのversion確認](v1.4.0/edge-workerd/version-check.json)でpackage manifestと`shared.js`の`VERSION`がともに1.4.0、resolvedが公開registry、integrityが`sha512-R3xpMJr3rBv+LsyfpggixCZvktlS3XRvLi542x4JgbrvvBP3NH/xip3TJSze4fGDQIfj7hWplLeKUlHPCnidew==`であることを確認した。[v1.3.1のEdge実測](WASM_1.3.1_EDGE_VERIFICATION.md)と[v1.4.0のnative・Chrome公開後実測](V1.4.0_VERIFICATION.md)は各々元の日時・versionの証拠として保持する。
...
|---|---:|---|---|
| 小JPEG→WebP probe（集計対象外） | 224.5 / 192.0 / 113.9 | [320×320、17,484 B](v1.4.0/edge-workerd/wasm-edge-probe-jpeg-webp.webp) | PASS |
| JPEG→WebP、resize | 3,705.5 / 3,675.6 / 2,619.5 | [1600×1600、328,690 B](v1.4.0/edge-workerd/wasm-edge-jpeg-webp.webp)、500,000 B以下 | PASS |
| PNG→JPEG、resize | 3,101.6 / 3,070.3 / 1,995.4 | [1600×1600、430,035 B](v1.4.0/edge-workerd/wasm-edge-png-jpeg.jpg)、450,000 B以下 | PASS |
| metadata→JPEG | 92.7 / 63.6 / 39.2 | [180×240、5,886 B](v1.4.0/edge-workerd/wasm-edge-metadata-budget.jpg)、30,000 B以下 | PASS |
...
```bash
git checkout 9c22cf3cdeeb7aa515b59107a2834e2c14495323
