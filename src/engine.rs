...
// Import task types from tasks module
#[cfg(feature = "napi")]
use crate::engine::tasks::{BatchTask, EncodeTask, EncodeWithMetricsTask, WriteFileTask};
...
// BatchResult is imported from tasks module above
...
// Async tasks are now in engine/tasks.rs
#[cfg(feature = "stress")]
