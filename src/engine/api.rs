...
// Validation helpers are in the sibling `validation` module (src/engine/validation.rs).
// Re-import under the `validation` namespace so all call-sites remain unchanged.
#[cfg(feature = "napi")]
...
pub use super::metadata::MetadataPolicy;
