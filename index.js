  ...
  if (typeof error.code === 'string') {
    switch (error.code) {
      case 'LAZY_IMAGE_USER_ERROR':
        return nativeBinding.ErrorCategory?.UserError ?? null
      case 'LAZY_IMAGE_CODEC_ERROR':
        return nativeBinding.ErrorCategory?.CodecError ?? null
      case 'LAZY_IMAGE_RESOURCE_LIMIT':
        return nativeBinding.ErrorCategory?.ResourceLimit ?? null
      case 'LAZY_IMAGE_INTERNAL_BUG':
        return nativeBinding.ErrorCategory?.InternalBug ?? null
      default:
        break
    }
  }
...
module.exports.createStreamingPipeline = (options) =>
  createStreamingPipeline({ ...options, ImageEngine: nativeBinding.ImageEngine })
